    ...
    foreach (explode('/', $format) as $part) {
      ...
      switch ($char) {
        ...
        case 's':
          ...
          break;
        case 'S':
          // unpack('V', 'ffffffff') returns already signed value on 32-bit PHP.
          //
          // echo unpack('V', hex2bin('ffffffff'))[1];
          //   //=> -1
          // echo unpack('V', hex2bin('ffffffff'))[1] - (0xFFFFFFFF + 1);
          //   //=> -4294967297 (80000000h)
          // echo (int) -4294967297;
          //   //=> -1
          $complement = (PHP_INT_SIZE === 4 and !$pack) ? 0 : 0xFFFFFFFF + 1;
          $value = $number(4, -0x80000000, 0x7FFFFFFF, 'V', $complement);
          break;
        case 'z':
          if ($pack) {
...
class CLI {
  ...
  static function checkModule($func, $module, $desc) {
